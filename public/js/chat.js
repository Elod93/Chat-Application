...
const autoscroll = () => {
    ...
    const newMessageHeght = $newMessage.offsetHeight + newMessageMargin
    ...
    if (containerHeight - newMessageHeght <= scrollOffset) {
...
document.querySelector('#send-location').addEventListener('click', () => {
    if (!navigator.geolocation) {
        return alert('Your browser is not support this future')
    }
...
//     console.log('Count has benn updated',count)
